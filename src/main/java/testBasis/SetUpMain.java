...
public class SetUpMain {
	...
	public SetUpMain() throws IOException {
		...
		prop=new Properties();
		FileInputStream fis=new FileInputStream("C:\\Users\\ahmed.abdelstar\\eclipse-workspace\\FTAssessment\\TestDataIn\\properties.properties");
		prop.load(fis);
	}
	...
	public void openBrowser(String browser, Method methods ) throws InterruptedException, IOException {
		...
		if(browser.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\ahmed.abdelstar\\eclipse-workspace\\FTAssessment\\TestDataIn\\chromedriver.exe");
			...
			System.setProperty("webdriver.gecko.driver","C:\\Users\\ahmed.abdelstar\\eclipse-workspace\\FTAssessment\\TestDataIn\\geckodriver.exe");
			driver=new FirefoxDriver();
		}

		else if(browser.equalsIgnoreCase("ie")) {
			System.setProperty("webdriver.ie.driver", "C:\\Users\\ahmed.abdelstar\\eclipse-workspace\\FTAssessment\\TestDataIn\\IEDriverServer.exe");
			driver=new InternetExplorerDriver();
		}

		else if(browser.equalsIgnoreCase("edge")) {
			System.setProperty("webdriver.edge.driver", "C:\\Users\\ahmed.abdelstar\\eclipse-workspace\\FTAssessment\\TestDataIn\\msedgedriver.exe");
